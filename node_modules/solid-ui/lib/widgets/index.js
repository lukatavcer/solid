...
var widgets = module.exports = Object.assign({}, require('./peoplePicker'), // UI.widgets.PeoplePicker
...
**
*/
UI.widgets.field[UI.ns.ui('Form').uri] = UI.widgets.field[UI.ns.ui('Group').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var kb = UI.store;
...
**
*/
UI.widgets.field[UI.ns.ui('Options').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var kb = UI.store;
  var box = dom.createElement('div');
...
**
*/
UI.widgets.field[UI.ns.ui('Multiple').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
...
UI.widgets.fieldParams[UI.ns.ui('PhoneField').uri].pattern = /^\+?[\d-]+[\d]*$/;
...
UI.widgets.field[UI.ns.ui('PhoneField').uri] = UI.widgets.field[UI.ns.ui('EmailField').uri] = UI.widgets.field[UI.ns.ui('ColorField').uri] = UI.widgets.field[UI.ns.ui('DateField').uri] = UI.widgets.field[UI.ns.ui('DateTimeField').uri] = UI.widgets.field[UI.ns.ui('TimeField').uri] = UI.widgets.field[UI.ns.ui('NumericField').uri] = UI.widgets.field[UI.ns.ui('IntegerField').uri] = UI.widgets.field[UI.ns.ui('DecimalField').uri] = UI.widgets.field[UI.ns.ui('FloatField').uri] = UI.widgets.field[UI.ns.ui('TextField').uri] = UI.widgets.field[UI.ns.ui('SingleLineTextField').uri] = UI.widgets.field[UI.ns.ui('NamedNodeURIField').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var ui = UI.ns.ui;
  var kb = UI.store;
...
UI.widgets.field[UI.ns.ui('MultiLineTextField').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var ui = UI.ns.ui;
  var kb = UI.store;
  var property = kb.any(form, ui('property'));
  if (!property) {
...
UI.widgets.field[UI.ns.ui('BooleanField').uri] = function (dom, container, already, subject, form, store, callbackFunction, tristate) {
  return booleanField(dom, container, already, subject, form, store, callbackFunction, false);
};

UI.widgets.field[UI.ns.ui('TristateField').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
...
UI.widgets.field[UI.ns.ui('Classifier').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var kb = UI.store;
  var ui = UI.ns.ui;
...
UI.widgets.field[UI.ns.ui('Choice').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var ui = UI.ns.ui;
  var ns = UI.ns;
  var kb = UI.store;
  var multiple = false;
  ...
  function addSubForm(ok, body) {
    ...
    UI.widgets.fieldFunction(dom, subForm)(dom, rhs, already, object, subForm, store, callbackFunction);
  }
  ...
  var selector = UI.widgets.makeSelectForOptions(dom, kb, subject, property, possible2, opts, store, callbackFunction);
...
UI.widgets.field[UI.ns.ui('Comment').uri] = UI.widgets.field[UI.ns.ui('Heading').uri] = function (dom, container, already, subject, form, store, callbackFunction) {
  var ui = UI.ns.ui;
  var kb = UI.store;
...
UI.widgets.editFormButton = function (dom, container, form, store, callbackFunction) {
  ...
  b.addEventListener('click', function (e) {
    var ff = UI.widgets.appendForm(dom, container, {}, form, UI.ns.ui('FormForm'), store, callbackFunction);
...
UI.widgets.newButton = function (dom, kb, subject, predicate, theClass, form, store, callbackFunction) {
  ...
  b.addEventListener('click', function (e) {
    b.parentNode.appendChild(UI.widgets.promptForNew(dom, kb, subject, predicate, theClass, form, store, callbackFunction));
  }, false);
  return b;
};
...
UI.widgets.makeSelectForOptions = function (dom, kb, subject, predicate, possible, options, store, callbackFunction) {
...
UI.widgets.makeSelectForCategory = function (dom, kb, subject, category, store, callbackFunction) {
  ...
  return UI.widgets.makeSelectForOptions(dom, kb, subject, UI.ns.rdf('type'), subs, { 'multiple': multiple, 'nullPrompt': '--classify--' }, store, callbackFunction);
};
...
UI.widgets.makeSelectForNestedCategory = function (dom, kb, subject, category, store, callbackFunction) {
  ...
  var update = function () {
    ...
    if (select.currentURI && kb.any(kb.sym(select.currentURI), UI.ns.owl('disjointUnionOf'))) {
      child = UI.widgets.makeSelectForNestedCategory(dom, kb, subject, kb.sym(select.currentURI), store, callbackFunction);
  ...
  var boxHandler = function (e) {
    ...
    UI.store.updater.update(toDelete, toInsert, function (uri, success, errorBody) {
      if (!success) {
        ...
        box.appendChild(UI.widgets.errorMessageBlock(dom, `Checkbox: Error updating store from ${input.state} to ${input.newState}:\n\n${errorBody}`));
      } else {
...
//
UI.widgets.selectorPanel = function (dom, kb, type, predicate, inverse, possible, options, callbackFunction, linkCallback) {
  return UI.widgets.selectorPanelRefresh(dom.createElement('div'), dom, kb, type, predicate, inverse, possible, options, callbackFunction, linkCallback);
};

UI.widgets.selectorPanelRefresh = function (list, dom, kb, type, predicate, inverse, possible, options, callbackFunction, linkCallback) {
